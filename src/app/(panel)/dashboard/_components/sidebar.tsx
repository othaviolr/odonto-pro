...
export function SidebarDashboard({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen w-full">
      <aside
        className={clsx(
          "flex flex-col border-r bg-background tracking-all duration-300 p-4 h-full",
          {
            "w-20": isCollapsed,
            "w-64": !isCollapsed,
      ...
      >
        ...
        <Button
          className="bg-gray-400 hover:bg-gray-50 text-zinc-900 self-end mb-2"
          ...
          <CollapsibleContent>
            <nav className="flex flex-col gap-1 overflow-hidden">
              ...
              <SidebarLink
                ...
                icon={<Folder className="w-6 h-6" />}
              />
              <span className="text-sm text-gray-400 font-medium mt-1 uppercase"></span>
              <SidebarLink
                href="/dashboard/profile"
                label="Meu Perfil"
                pathname={pathname}
      ...
      <div
        className={clsx("flex flex-l flex-col transition-all duration-300", {
        ...
        <header className="md:hidden flex items-center justify-between border-b px-2 md:px-6 h-14 z-10 sticky top-0 bg-white">
          <Sheet>
            ...
            <SheetContent side="right" className="sm:max-w-xs text-black">
              ...
              <nav className="grid gap-2 tex-base pt-5">
                <SidebarLink
                  href="/dashboard"
                  label="Agendamentos"
                  pathname={pathname}
